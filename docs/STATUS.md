...
5. (แผนรอบถัดไป) DR premium/discount เทียบหุ้นแม่ (ต้องหาแหล่งราคา DR จาก SET + USDTHB ที่เสถียร) · สถิติผลงานสะสมจาก signals.json (win rate แยกเกรด, drift 5/20/60 วัน — รอข้อมูลสะสมก่อน)
